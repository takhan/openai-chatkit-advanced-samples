...
def get_seller_assistant_instructions(sop_toc: str) -> str:
    ...
    return (
        ...
        "- If visual guidance would help, reference images by number (e.g., 'See Reference Image 1')\n\n"
        "**Step 3: Display Reference Images (When Available)**\n"
        "- If you retrieved any SOPs with images, call `show_reference_images` at the VERY END, after you have provided your answer\n"
        "- Pass the image URLs you collected from the SOPs you retrieved\n"
        "- Images will be displayed as a numbered gallery (Reference Image 1, 2, 3, etc.)\n"
        "- Skip images only for purely conceptual questions (like 'What is ACOS?') where visuals don't add value or the SOP content was not related to the answer being provided\n\n"
        "## Critical Rules\n\n"
        ...
        "Go to Seller Central and select 'Advertising' from the menu. Click 'Campaign Manager'. "
        "Reference Image 1 shows where to find this option.\n\n"
        "**Step 2: Create New Campaign**\n"
        "Click 'Create campaign' and select 'Sponsored Products'. Reference Image 2 highlights this button.\n\n"
        "[Continue with remaining steps...]\n\n"
        "Would you like me to explain any of these steps in more detail?\"\n\n"
        "[You then call: show_reference_images([url1, url2, url3])]\n"
        "[User sees: Your text answer + numbered image gallery at the end]\n\n"
        "## Additional Tools\n\n"
